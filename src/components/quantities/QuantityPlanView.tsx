  ...
  return (
    <div className="flex flex-1 flex-col overflow-hidden">
      ...
      <div className="mt-2 flex flex-wrap items-center gap-3 print:mt-3">
        ...
        {result.cutGroups.map((g, i) => (
          <div key={`${g.usedW}×${g.usedH}|${g.pieceEdges.left}|${g.pieceEdges.right}|${g.pieceEdges.top}|${g.pieceEdges.bottom}`} className="flex items-center gap-1.5 text-[11px] text-zinc-400">
            <span
