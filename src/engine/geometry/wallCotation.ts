...
// ── Constantes ────────────────────────────────────────────────────────────
const COTE_OFFSET_EXT = 50;  // mm depuis la face extérieure
const COTE_OFFSET_INT = 50;  // mm depuis la face intérieure, vers l'intérieur
const COTE_OFFSET_ISO = 50;  // mm depuis l'axe, mur isolé
